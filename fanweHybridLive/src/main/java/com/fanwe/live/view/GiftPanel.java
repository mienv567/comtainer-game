...
public class GiftPanel {
    ...
    public GiftPanel(Context context, int role) {
        mRootView = LayoutInflater.from(context).inflate(R.layout.panel_live_h_gift, null);
        ListView lvOrder = (ListView) mRootView.findViewById(R.id.lv_gift);
