...
public class GloveLayout extends RelativeLayout
{

    private static final int GLOVE_WIDTH = SDViewUtil.dp2px(25);
    ...
    private int height;
    private int width;
    private LayoutParams gloveLayoutParams;
    private Random random = new Random();
    private int drawableHeight;
    private int drawableWidth;

    public GloveLayout(Context context)
    {
        super(context);
        init();
    }

    public GloveLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }

    public GloveLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    private void init()
    {
        ...
        listDrawableName.add("glove1");
        listDrawableName.add("glove2");
        listDrawableName.add("glove3");
        listDrawableName.add("glove4");
        listDrawableName.add("glove5");
        listDrawableName.add("glove6");
        listDrawableName.add("glove7");
    ...
    private void createGloveLayoutParams()
    {
        gloveLayoutParams = new LayoutParams(GLOVE_WIDTH, GLOVE_WIDTH);
        gloveLayoutParams.addRule(CENTER_HORIZONTAL, TRUE);// 这里的TRUE 要注意 不是true
        gloveLayoutParams.addRule(ALIGN_PARENT_BOTTOM, TRUE);
    }
    ...
    public void addHeart(String imageName)
    {
        ...
        if (drawable != null)
        {
            ...
            imageView.setLayoutParams(gloveLayoutParams);
