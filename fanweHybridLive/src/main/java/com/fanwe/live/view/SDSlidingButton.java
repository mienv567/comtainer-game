...
import com.fanwe.library.gesture.SDScrollGestureHelper;
...
public class SDSlidingButton extends RelativeLayout
{
    ...
    private SDScrollGestureHelper scrollHelper;
    ...
    private void init()
    {
        ...
        scrollHelper = new SDScrollGestureHelper(getContext());
    }
    ...
    private void scrollToLeft(boolean smooth)
    {
        ...
        if (smooth)
        {
            int dur = SDGestureHelper.getDurationPercent(marginParams.leftMargin, marginLeft, getMaxMargin(), DUR_MAX);
            scrollHelper.getScroller().startScrollToX(marginParams.leftMargin, marginLeft, dur);
            postInvalidate();
        } else
        {
    ...
    private void scrollToRight(boolean smooth)
    {
        ...
        if (smooth)
        {
            int dur = SDGestureHelper.getDurationPercent(marginParams.leftMargin, getMaxMargin(), getMaxMargin(), DUR_MAX);
            scrollHelper.getScroller().startScrollToX(marginParams.leftMargin, getMaxMargin(), dur);
            postInvalidate();
        } else
        {
    ...
    {
        if (scrollHelper.getScroller().computeScrollOffset())
        {
            ...
            {
                updateLeftMargin(scrollHelper.getScroller().getCurrX());
            }
        }
        postInvalidate();
    }
