 ...
 */
public class LiveUserHomeScrollView extends LazyScrollView {
    private ScrollViewListener scrollViewListener = null;


    public LiveUserHomeScrollView(Context context) {
        super(context);
    }

    public LiveUserHomeScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

	public LiveUserHomeScrollView(Context context, AttributeSet attrs, int defStyle) {
