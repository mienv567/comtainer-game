...
public class LiveSelectLiveView extends BaseAppView
{
        ...
        CommonInterface.requestIndexSearch_area(sex, new AppRequestCallback<IndexSearch_areaActModel>()
        {
            ...
            protected void onSuccess(SDResponse resp)
            {
                if (actModel.isOk())
                {
                    ...
                    if (index < 0)
                    {
                        index = findCityIndex(LiveConstant.LIVE_HOT_CITY);
                        setCity(LiveConstant.LIVE_HOT_CITY);
                    }
    ...
    private void register()
    {
        lv_city.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                SelectCityModel item = adapter.getItem((int) id);
    ...
    private void initTabSex()
    {
        ...
        viewManager.setListener(new SDSelectManager.SDSelectManagerListener<View>()
        {
            @Override
