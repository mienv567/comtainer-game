...
public class LiveFamilyApplyFragment extends BaseFragment
{
    ...
    private void requestFamilyMembersApplyList(final boolean isLoadMore)
    {
        ...
        CommonInterface.requestFamilyMembersApplyList(dao.getFamilyId(),page, new AppRequestCallback<App_family_user_r_user_listActModel>()
        {
            @Override
    ...
    public void  setApplyRsCount(SDTabUnderline textView)
    {
