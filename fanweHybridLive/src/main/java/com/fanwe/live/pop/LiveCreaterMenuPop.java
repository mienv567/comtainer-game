...
public class LiveCreaterMenuPop extends SDPopupWindow
{
    ...
    public LiveCreaterMenuModel modelflash;
    ...
    private void bindData()
    {
        ...
        modelShare.setTextNormal(SDResourcesUtil.getString(R.string.share));
        modelShare.setTextSelected(SDResourcesUtil.getString(R.string.share));
        ...
        modelflash.setTextNormal(SDResourcesUtil.getString(R.string.flash_light));
        modelflash.setTextSelected(SDResourcesUtil.getString(R.string.flash_light));
...
//        boolean isFrontCamera = QavsdkControl.getInstance().getAVCameraManager().isFrontCamera();
//        modelflash.setEnable(!isFrontCamera);

        // 切换摄像头
        modelChangeCamera = new LiveCreaterMenuModel();
        modelChangeCamera.setTextNormal(SDResourcesUtil.getString(R.string.over_turn));
        modelChangeCamera.setTextSelected(SDResourcesUtil.getString(R.string.over_turn));
        ...
        modelMic.setTextNormal(SDResourcesUtil.getString(R.string.mic));
        modelMic.setTextSelected(SDResourcesUtil.getString(R.string.mic));
        ...
        modelBeauty.setTextNormal(SDResourcesUtil.getString(R.string.beauty));
        modelBeauty.setTextSelected(SDResourcesUtil.getString(R.string.beauty));
    ...
    public void onEventMainThread(ESwitchCameraComplete event)
    {
        if (event.cameraId == 0)
        {
            modelflash.setEnable(false);
            modelflash.setSelected(false);
            adapter.notifyDataSetChanged();
        } else
        {
            modelflash.setEnable(true);
        }
    }
