...
public class MusicEffectDialog extends Dialog implements View.OnClickListener
{
    ...
    private IPlayCtrl mPlayCtrlCallback;
    ...
    protected void initView()
    {
        ...
        mItems.add(createItem(SDResourcesUtil.getString(R.string.orginal_sound)));
        mItems.add(createItem(SDResourcesUtil.getString(R.string.mellow_full)));
        mItems.add(createItem(SDResourcesUtil.getString(R.string.popular)));
        mItems.add(createItem(SDResourcesUtil.getString(R.string.low_deep)));
        mItems.add(createItem(SDResourcesUtil.getString(R.string.resounding)));
        mItems.add(createItem(SDResourcesUtil.getString(R.string.intangible)));
        mItems.add(createItem(SDResourcesUtil.getString(R.string.rap)));
        ...
        mPlayCtrl = SDConfig.getInstance().getObject(PlayCtrl.class);
        if (mPlayCtrl == null)
        {
    ...
    public void setPlayCtrlListener(IPlayCtrl playCtrl)
    {
        mPlayCtrlCallback = playCtrl;
    }
...
//                mItems.get(i).setBackground(getContext().getDrawable(R.drawable.bg_room_effect_circle_item_nor));
    ...
    {
        super.dismiss();
        SDConfig.getInstance().setObject(mPlayCtrl);
    }

    protected void updatePlayCtrl()
    {
        if (mPlayCtrlCallback != null)
        {
            mPlayCtrlCallback.onPlayCtrl(mPlayCtrl);
        }
    }
