...
import com.fanwe.hybrid.utils.UrlUtils;
import com.fanwe.library.utils.SDToast;
import com.fanwe.live.R;
import com.fanwe.live.model.item.FamilyCommentItem;
import com.fanwe.live.span.CircleMovementMethod;
import com.fanwe.live.span.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    private List<FamilyCommentItem> mDatas;
    ...
    public void setDatas(List<FamilyCommentItem> datas){
        if(datas == null ){
            datas = new ArrayList<FamilyCommentItem>();
        }
        mDatas = datas;
        notifyDataSetChanged();
    }

    public List<FamilyCommentItem> getDatas(){
        return mDatas;
    }
    ...
    private View getView(final int position){
        ...
        final FamilyCommentItem bean = mDatas.get(position);
        String name = bean.userName;
        String id = bean.id + "";
        String toReplyName = "";
        if (!TextUtils.isEmpty(bean.replyUserName)) {
            toReplyName = bean.replyUserName;
        }
        ...
        if (!TextUtils.isEmpty(toReplyName)) {
            ...
            builder.append(" 回复 ");
            builder.append(setClickableSpan(toReplyName, bean.replyUserId+""));
        }
        builder.append(": ");
        //转换表情字符
        String contentBodyStr = bean.comment;
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        SDToast.showToast(textStr + " &id = " + id, Toast.LENGTH_SHORT);
                                    }
