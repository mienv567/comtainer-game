...
{
    @ViewInject(R.id.txv_add_fam)
    private TextView txv_add_fam;//加入家族
    @ViewInject(R.id.txv_new_fam)
    private TextView txv_new_fam;//创建家族
...
//        paddings(0);
    ...
    {
        txv_add_fam.setOnClickListener(this);
        txv_new_fam.setOnClickListener(this);
    }
