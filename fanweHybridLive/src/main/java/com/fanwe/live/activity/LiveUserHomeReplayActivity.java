...
public class LiveUserHomeReplayActivity extends BaseTitleActivity
{
    ...
    {
        mTitle.setMiddleTextTop(getString(R.string.my_live));
    }

    private void addSortTab()
    {
        left_tab_sort0.setTextTitle(getString(R.string.newest));
        left_tab_sort0.getViewConfig(left_tab_sort0.mTvTitle).setTextColorNormalResId(R.color.gray).setTextColorSelectedResId(R.color.main_color);
        left_tab_sort0.setBackgroundColor(Color.parseColor("#ededed"));
//        left_tab_sort0.getViewConfig(left_tab_sort0.mIvLeft).setBackgroundNormalResId(R.drawable.ic_me_jiantou2).setBackgroundSelectedResId(R.drawable.ic_me_jiantou2);
        ...
        left_tab_sort1.setTextTitle(getString(R.string.hotest));
        left_tab_sort0.setBackgroundColor(Color.parseColor("#ededed"));
        left_tab_sort1.getViewConfig(left_tab_sort1.mTvTitle).setTextColorNormalResId(R.color.gray).setTextColorSelectedResId(R.color.main_color);
...
//                        showBotDialog(room_id);
    ...
    private void showBotDialog(final int room_id)
    {
        String[] arrOption = new String[]
                {getString(R.string.remove_video)};
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("直播回放列表界面");
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("直播回放列表界面");
