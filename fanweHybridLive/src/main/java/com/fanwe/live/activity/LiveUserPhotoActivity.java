...
public class LiveUserPhotoActivity extends BaseActivity
{
    ...
    {
        SDViewBinder.setImageView(LiveUserPhotoActivity.this,url, iv_head_img,R.drawable.ic_default_head);
    }
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("头像编辑界面");
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("头像编辑界面");
