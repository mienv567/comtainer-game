...
//        }
    ...
    private void init() {
        ...
        sv_song.getEtInput().setHint(R.string.search_user_topic);
        ...
        fragUser.setOnItemClickListener(new LiveSerchUserModelAdapter.OnItemClickListener() {
            @Override
    ...
    private void initTabs() {
        tab_live_user.setTextTitle(getString(R.string.user));
           tab_live_user.getViewConfig(tab_live_user.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.white));
        tab_live_user.getViewConfig(tab_live_user.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.white)).setTextColorSelected(SDResourcesUtil.getColor(R.color.white));

        tab_live_topic.setTextTitle(getString(R.string.topic));
        tab_live_topic.getViewConfig(tab_live_topic.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.white));
        tab_live_topic.getViewConfig(tab_live_topic.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.white)).setTextColorSelected(SDResourcesUtil.getColor(R.color.white));
