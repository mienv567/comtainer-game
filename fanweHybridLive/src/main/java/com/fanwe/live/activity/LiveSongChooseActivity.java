...
//						LiveUserSongManager.getInstance().addList(actModel.getManageList());
					}
					mPage += 1;
					mActModel = actModel;
				}else {
	...
	public void onXItemLongClick(int position, View convertView,
		...
		dialog.setItems(new String[] { getString(R.string.remove) });
	...
	protected void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("选歌界面");
