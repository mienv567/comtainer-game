...
import static com.fanwe.live.R.id.RemoteWindowA;
...
public class LiveViewerActivity extends LiveLayoutViewerActivity {
    ...
    private RTCVideoWindow mRTCVideoWindowC;
    // 七牛sdk相关
    ...
    private void initViceAnchor() {
         ...
         */
        mRemoteWindowA = new RTCVideoWindow(findViewById(RemoteWindowA), (GLSurfaceView) findViewById(R.id.RemoteGLSurfaceViewA));
        ...
        mRTCVideoWindowA = mRemoteWindowA;
        mRTCVideoWindowB = mRemoteWindowB;
        mRTCVideoWindowB = mRemoteWindowC;
    ...
    protected boolean validateParams(int roomId, String groupId, String createrId) {
        ...
        if (isEmpty(groupId)) {
            SDToast.showToast(getString(R.string.im_room_id_empty));
            finish();
            return false;
        }

        if (isEmpty(createrId)) {
            SDToast.showToast(getString(R.string.anchor_id_empty));
            finish();
            return false;
        }
        setRoomId(roomId);
    ...
    protected void onMsgLRS(MsgModel msg) {
        ...
        switch (msg1.getStep()) {
            ...
            case 12://结束游戏
                ...
                mRTCAudioStreamingManager.stopCapture();
                mRTCStreamingManager.startCapture();
                LRSResultDialog dialog = new LRSResultDialog(LiveViewerActivity.this, msg1.getWin());
                dialog.show();
    ...
    protected void onMsgStopVideo(MsgModel msg) {
        ...
        if (!LRSManager.getInstance().mIsGaming) {
            SDToast.showToast(getString(R.string.anchor_close_small_video));
        }
    }
    ...
    public void onClickUserANickName(View v) {
        ...
        LiveUserInfoDialog dialog = new LiveUserInfoDialog(LiveViewerActivity.this, names.get(0));
        dialog.show();
    ...
    public void onClickUserBNickName(View v) {
        ...
        LiveUserInfoDialog dialog = new LiveUserInfoDialog(LiveViewerActivity.this, names.get(1));
        dialog.show();
    }
    ...
    public void onClickUserCNickName(View v) {
        ...
        LiveUserInfoDialog dialog = new LiveUserInfoDialog(LiveViewerActivity.this, names.get(2));
        dialog.show();
    }
