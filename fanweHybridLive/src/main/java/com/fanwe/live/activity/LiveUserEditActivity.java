...
public class LiveUserEditActivity extends BaseTitleActivity implements OnDateSetDialogListener {
    ...
    @ViewInject(R.id.iv_edit_nickname)
    ...
    private final String KEY_NICK_NAME = "nickName";//昵称对应的key
    ...
    private final String KEY_AFFECTIVE_STATE = "emotionalState";//情感状态对应的key
    ...
    private void init() {
        ...
        iv_edit_nickname.setOnClickListener(this);
    }
    ...
    private void requestUserInfo() {
        CommonInterface.requestUserInfoJava(null, null, new AppRequestCallback<UserModel>() {
            @Override
            protected void onSuccess(SDResponse resp) {
                ...
                mOriginElement.put(KEY_NICK_NAME, user.getNickName());
                ...
                mOriginElement.put(KEY_AFFECTIVE_STATE, user.getEmotionalState());
                ...
                affectiveState = user.getEmotionalState();
                city = user.getCity();
                province = user.getProvince();
                homeTown = getHomeTown(city, province);
                sex = user.getSex();
                is_edit_sex = user.getIsEditSex();
                image_url = user.getHeadImage();
                SDViewBinder.setImageView(LiveUserEditActivity.this, image_url, iv_head_img, R.drawable.ic_default_head);
                ...
                //                tv_authentication_state.setText(getAuthenticationState(user.getIsAuthentication()));
                tv_birthday.setText(user.getBirthday());
                tv_affective_state.setText(user.getEmotionalState());
    ...
    private void initTitle() {
        mTitle.setMiddleTextTop(getString(R.string.compile));
    ...
    private String getHomeTown(String province, String city) {
        if (TextUtils.isEmpty(province) && TextUtils.isEmpty(city)) {
            return getString(R.string.mala_star);
        }
            ...
            mDialogEditSex.setOnChooseSexListener(new LiveUserSexEditDialog.OnChooseSexListener() {
                ...
                public void chooseSex(int flag, int chosesex, boolean isChanged) {
                    if (is_edit_sex == 1) {
                        ...
                        SDToast.showToast(getString(R.string.gender_not_compile_many_times));
                    }
                }
            });
        }
    ...
    private void initTimePicker() {
        mTimePicker = new LiveTimePickerDialog.Builder()
                .setCallBack(this)
                .setTitleStringId(getString(R.string.please_choose_birth_day))
                .setCyclic(false)
    ...
    public void onEventMainThread(EUserImageUpLoadComplete event) {
        ...
        SDViewBinder.setImageView(this, image_url, iv_head_img, R.drawable.ic_default_head);
    }
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("用户信息编辑界面");
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("用户信息编辑界面");
