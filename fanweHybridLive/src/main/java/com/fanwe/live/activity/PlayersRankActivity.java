...
import com.fanwe.live.fragment.PlayerRankFragment;
...
public class PlayersRankActivity extends BaseActivity {

    private String[] mTabTitles = {"魅力榜", "点赞榜", "任务榜", "积分榜"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_players_rank);
        initFragment();
    }

    private void initFragment() {
        for (int i = 0; i < mTabTitles.length; i++) {
            mFragments.add(PlayerRankFragment.newInstance(i));
        }
