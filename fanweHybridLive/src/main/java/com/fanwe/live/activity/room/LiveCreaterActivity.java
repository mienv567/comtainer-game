...
//        if (avuiControl != null) {
//            avuiControl.shouldInterceptEvent(ev);
//        }
    ...
    public void onEventMainThread(ETouchSWNickName event) {
        LiveUserInfoDialog dialog = new LiveUserInfoDialog(LiveCreaterActivity.this, event.getIdentifier());
        dialog.show();
    }
...
//        }
    ...
    protected void initLayout(View view) {
        ...
        if (mRole == RTC_ROLE_ANCHOR) {
            ...
            mRemoteWindowA.setRelativeMixOverlayRect(0.7f, 0.2f, 0.3f, 0.25f);
...
//                SDToast.showToast("开始游戏超时");
            ...
            case 4://游戏开始
                ...
                break;
            case 12://游戏结束
                LRSResultDialog dialog = new LRSResultDialog(LiveCreaterActivity.this, msg1.getWin());
                dialog.show();
...
//        }
    ...
    private void showNormalExitDialog() {
        LiveCreaterFinishDialog dialog = new LiveCreaterFinishDialog(this);
        dialog.setTextContent(String.format(getString(R.string.if_ensure_finish_live),roomInfoView.getVierwerNumber()));
...
//        SDToast.showToast("onClickUserANickName");
        ...
        LiveUserInfoDialog dialog = new LiveUserInfoDialog(LiveCreaterActivity.this, names.get(0));
        dialog.show();
...
//        SDToast.showToast("onClickUserBNickName");
        ...
        LiveUserInfoDialog dialog = new LiveUserInfoDialog(LiveCreaterActivity.this, names.get(1));
        dialog.show();
    }
...
//        SDToast.showToast("onClickUserCNickName");
        ...
        LiveUserInfoDialog dialog = new LiveUserInfoDialog(LiveCreaterActivity.this, names.get(2));
        dialog.show();
    }
