...
{
    public MsgGiftCreaterViewHolder(View itemView, SDRecyclerAdapter<MsgModel> adapter)
    {
    ...
    protected void bindCustomMsg(int position, CustomMsg customMsg)
    {
        ...
        appendUserInfoNotFormat(msg.getSender(), LiveConstant.LiveMsgType.MSG_GIFT_CREATER);

        String text = " " + msg.getDesc2();
        int textColor = SDResourcesUtil.getColor(R.color.live_gift);
