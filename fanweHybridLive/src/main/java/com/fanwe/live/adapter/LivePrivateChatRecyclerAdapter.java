    ...
    public SDRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        switch (viewType)
        {
            case LiveConstant.PrivateMsgType.MSG_TEXT_LEFT:
                viewHolder = new MsgTextLeftViewHolder(inflate(R.layout.item_private_chat_text_left, parent), this);
                break;
            case LiveConstant.PrivateMsgType.MSG_TEXT_RIGHT:
                View view = getActivity().getLayoutInflater().inflate(R.layout.item_private_chat_text_right, parent, false);
                viewHolder = new MsgTextRightViewHolder(view, this);
                break;
            case LiveConstant.PrivateMsgType.MSG_VOICE_LEFT:
                viewHolder = new MsgVoiceLeftViewHolder(inflate(R.layout.item_private_chat_voice_left, parent), this);
                break;
            case LiveConstant.PrivateMsgType.MSG_VOICE_RIGHT:
                viewHolder = new MsgVoiceRightViewHolder(inflate(R.layout.item_private_chat_voice_right, parent), this);
                break;
            case LiveConstant.PrivateMsgType.MSG_IMAGE_LEFT:
                viewHolder = new MsgImageLeftViewHolder(inflate(R.layout.item_private_chat_image_left, parent), this)
                {
                    @Override
            ...
            case LiveConstant.PrivateMsgType.MSG_IMAGE_RIGHT:
                viewHolder = new MsgImageRightViewHolder(inflate(R.layout.item_private_chat_image_right, parent), this)
                {
                    @Override
            ...
            case LiveConstant.PrivateMsgType.MSG_GIFT_LEFT:
                viewHolder = new MsgGiftLeftViewHolder(inflate(R.layout.item_private_chat_gift_left, parent), this);
                break;
            case LiveConstant.PrivateMsgType.MSG_GIFT_RIGHT:
                viewHolder = new MsgGiftRightViewHolder(inflate(R.layout.item_private_chat_gift_right, parent), this);
                break;
            default:
                break;
        }
