...
{
    public MsgGiftViewerViewHolder(View itemView, SDRecyclerAdapter<MsgModel> adapter)
    {
    ...
    protected void bindCustomMsg(int position, CustomMsg customMsg)
    {
        ...
        appendUserInfoNotFormat(msg.getSender(), LiveConstant.LiveMsgType.MSG_GIFT_VIEWER);
