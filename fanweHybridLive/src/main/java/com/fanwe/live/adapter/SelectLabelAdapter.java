...
public class SelectLabelAdapter extends SDSimpleAdapter<SelectLabelModel> {
    ...
    public void bindData(final int position, final View convertView, ViewGroup parent, final SelectLabelModel model) {
        ...
        tv_label.setTextColor(SDDrawable.getStateListColor(mActivity.getResources().getColor(R.color.black),mActivity.getResources().getColor(R.color.white),mActivity.getResources().getColor(R.color.white),mActivity.getResources().getColor(R.color.white)));
        if(model.isSelected()) {
