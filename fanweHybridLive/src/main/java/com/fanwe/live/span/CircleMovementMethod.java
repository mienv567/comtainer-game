...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = App.getApplication().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = App.getApplication().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
