 ...
 */
public class GinsengShootMarginActivity extends BaseTitleActivity
{
    /***
     * 竞拍商品id
     */
...
//        requestData();
    ...
    private void clickAgreement()
    {
        ...
        if (initActModel != null)
        {
            ...
            if (h5Model != null)
            {
                String url = h5Model.getUrl_auction_agreement();
    ...
    {
        Intent intent = new Intent(this, LiveRechargeActivity.class);
        startActivity(intent);
    }
