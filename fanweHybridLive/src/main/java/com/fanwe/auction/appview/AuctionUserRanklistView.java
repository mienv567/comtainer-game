...
public class AuctionUserRanklistView extends RoomView
{
    ...
    private void register()
    {
        ...
        adapter.setItemClickListener(new SDAdapter.ItemClickListener<PaiBuyerModel>()
        {
            @Override
            public void onClick(int position, PaiBuyerModel item, View view)
            {
                //查看用户信息
    ...
    {
        SDViewUtil.show(ll_rank_parent);
