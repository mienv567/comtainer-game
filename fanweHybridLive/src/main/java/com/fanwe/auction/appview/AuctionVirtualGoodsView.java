...
import com.fanwe.auction.activity.SelectDeliveryAddressMapActivity;
...
public class AuctionVirtualGoodsView extends AuctionGoodsBaseView implements TextView.OnEditorActionListener,OnDateSetDialogListener,OptionsPickerView.OnOptionsSelectListener{
    ...
    protected boolean isParamsComplete() {
        ...
        if(TextUtils.isEmpty(tv_contact_place.getText().toString())) {
    ...
    private void initAdapter() {
        ...
        mAdapterLabel.getSelectManager().setMode(SDSelectManager.Mode.SINGLE_MUST_ONE_SELECTED);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_auction_location :
                Intent intent = new Intent(getActivity(),SelectDeliveryAddressMapActivity.class);
    ...
    public void onEventMainThread(EUpLoadImageComplete event) {
        if(!TextUtils.isEmpty(event.server_full_path)) {
            mapPic.put(event.server_full_path,event.server_path);
