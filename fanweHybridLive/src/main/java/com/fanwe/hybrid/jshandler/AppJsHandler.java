...
public class AppJsHandler extends AppJsWHandler
{
    ...
    public void sdk_share(String json)
    {
        ...
        {
            e.printStackTrace();
            SDToast.showToast(mActivity.getString(R.string.data_analysis_exception));
        }
    }
    ...
    public void login_success(String json)
    {
        try
        {
            UserModel user = JsonUtil.json2Object(json, UserModel.class);
    ...
    {
        EFinshiActivity event = new EFinshiActivity();
        event.url = url;
        SDEventManager.post(event);
    }
    ...
    public void getClipBoardText()
    {
        ...
        {
            SDToast.showToast(activity.getString(R.string.not_copy_content));
        }
    }
