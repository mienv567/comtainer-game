...
public class SDTencentGeoCode
{
    ...
    public void suggestion(final SuggestionListener listener)
    {
            ...
            mSearch.suggestion(param, new HttpResponseListener()
            {
                ...
                public void onSuccess(int i, BaseObject obj)
                {
                    ...
                    } else
                    {
                        if (listener != null)
                        {
                            listener.onFailure(mContext.getString(R.string.search_suggestion_fail));
                        }
                    }
        ...
        {
            SDToast.showToast(mContext.getString(R.string.search_suggestion_setting_fail));
        }
    ...
    public void address2geo(final Address2GeoListener listener)
    {
            ...
            mSearch.address2geo(param, new HttpResponseListener()
            {
                ...
                public void onSuccess(int i, BaseObject obj)
                {
                    ...
                    } else
                    {
                        if (listener != null)
                        {
                            listener.onFailure(mContext.getString(R.string.analysis_location_fail));
                        }
                    }
                }
        ...
        {
            SDToast.showToast(mContext.getString(R.string.analysis_location_setting_fail));
        }
    }
    ...
    public void geo2address(final Geo2addressListener listener)
    {
            ...
            mSearch.geo2address(param, new HttpResponseListener()
            {
                ...
                public void onSuccess(int arg0, BaseObject obj)
                {
                    ...
                    } else
                    {
                        if (listener != null)
                        {
                            listener.onFailure(mContext.getString(R.string.longitude_latitude_analysis_fail));
                        }
                    }
                }
        ...
        {
            SDToast.showToast(mContext.getString(R.string.longitude_latitude_analysis_setting_fail));
        }
    }
