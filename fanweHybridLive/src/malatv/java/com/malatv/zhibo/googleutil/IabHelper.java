...
public class IabHelper {
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        try {
            logDebug("Constructing selector_corner5_yellow intent for " + sku + ", item type: " + itemType);
            ...
            if (response != BILLING_RESPONSE_RESULT_OK) {
                logError("Unable to selector_corner5_yellow item, Error response: " + getResponseDesc(response));
                flagEndAsync();
                result = new IabResult(response, "Unable to selector_corner5_yellow item");
                if (listener != null) listener.onIabPurchaseFinished(result, null);
                return;
            }

            PendingIntent pendingIntent = buyIntentBundle.getParcelable(RESPONSE_BUY_INTENT);
            logDebug("Launching selector_corner5_yellow intent for " + sku + ". Request code: " + requestCode);
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("ReturnPurchase",purchaseData);
        String dataSignature = data.getStringExtra(RESPONSE_INAPP_SIGNATURE);
        Log.d("ReturnPurchase",dataSignature);
