...
public class SDSlidingPlayView extends LinearLayout
{
    ...
    private void init()
    {
        ...
        v_division = findViewById(R.id.division);
        SDViewUtil.setViewHeight(ll_blur, SDViewUtil.dp2px(10));
    ...
    private void changeBottomViewByData()
    {
        ...
        switch (mode)
        {
            case IMAGE:
                if (count > 1)
                {
                    ll_bot.setGravity(Gravity.CENTER);
                    ll_blur.setBackgroundResource(0);
            ...
            case NUMBER:
                ...
                ll_bot.setGravity(Gravity.CENTER_VERTICAL | Gravity.RIGHT);
