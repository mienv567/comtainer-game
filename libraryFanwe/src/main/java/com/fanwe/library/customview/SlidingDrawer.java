...
public class SlidingDrawer extends ViewGroup
{
	...
	{
		if (offset >= 0 && offset < mHeightScreen)
		{
	...
	public SlidingDrawer(Context context, AttributeSet attrs, int defStyle)
	{
		...
		int orientation = a.getInt(R.styleable.SlidingDrawer_s_orientation, ORIENTATION_VERTICAL);
		mVertical = orientation == ORIENTATION_VERTICAL;
		mBottomOffset = (int) a.getDimension(R.styleable.SlidingDrawer_s_bottomOffset, 0.0f);
		mTopOffset = (int) a.getDimension(R.styleable.SlidingDrawer_s_topOffset, 0.0f);
		mAllowSingleTap = a.getBoolean(R.styleable.SlidingDrawer_s_allowSingleTap, true);
		mAnimateOnClick = a.getBoolean(R.styleable.SlidingDrawer_s_animateOnClick, true);

		int handleId = a.getResourceId(R.styleable.SlidingDrawer_s_handle, 0);
		if (handleId == 0)
		{
			throw new IllegalArgumentException("The handle attribute is required and must refer " + "to a valid child.");
		}
		int contentId = a.getResourceId(R.styleable.SlidingDrawer_s_content, 0);
		if (contentId == 0)
		{
		...
		mHeightScreen = getResources().getDisplayMetrics().heightPixels;
