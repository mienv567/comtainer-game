...
import com.qy.ysys.yishengyishi.spannable.CircleMovementMethod;
import com.qy.ysys.yishengyishi.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position){
        ...
        if (!TextUtils.isEmpty(toReplyName)) {
            ...
            builder.append(" 回复 ");
            builder.append(setClickableSpan(toReplyName, bean.getReplyUserId()+""));
        }
        builder.append(": ");
        //转换表情字符
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(AppImpl.getApplication(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
