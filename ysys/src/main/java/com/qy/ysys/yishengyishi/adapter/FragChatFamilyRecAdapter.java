...
public class FragChatFamilyRecAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FragChatFamilyRecAdapter(Context context, List<ModelFramilyChat> data) {
        this.mdata = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        if (type == ModelFramilyChat.CUSTOM) {
            View v = mInflater.inflate(R.layout.item_chat_familychat_custom, null);
            return new ViewHolderCustom(v, itemClickListener);
        } else {
            View v = mInflater.inflate(R.layout.item_chat_familychat, null);
...
//            ((ViewHolderCustom) viewHolder).iv_head.setBackgroundResource(R.mipmap.ic_selected_male);
            ((ViewHolderCustom) viewHolder).tv_title.setText("手动添加");
        }
    }
