...
public class PraiseListView extends TextView{
    ...
    private List<FamilyPraiseItem> datas;
    ...
    public List<FamilyPraiseItem> getDatas() {
        return datas;
    }
    public void setDatas(List<FamilyPraiseItem> datas) {
        this.datas = datas;
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(AppImpl.getApplication(), R.mipmap.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
