package com.qy.ysys.yishengyishi.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppImpl.getApplication().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppImpl.getApplication().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
